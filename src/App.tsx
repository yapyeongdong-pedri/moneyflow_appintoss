        ...
        <div className={`app-shell ${themeClass}`}>
          {showIntro ? (
            ...
            <>
              ...
              <section className="summary-card"><strong>월급통장에서 시작되는 내 흐름</strong><p>계좌 {graph.nodes.filter((n) => n.type === 'asset_account').length}개 · 카드 {graph.nodes.filter((n) => n.type === 'payment_instrument').length}개 · 지출항목 {graph.nodes.filter((n) => n.type === 'expense_category').length}개</p></section>
